<html>
    ...
    <div class="the-container"><div class="img-tablereserve-container"><div class="barbecue-image"><img src="../images/BarbecueNation.png" class="abbq-jpg"></div>
    <form class="book-a-table-form"method="POST" action="connect2.php">
