<html>
    ...
    <div class="the-container"><div class="img-tablereserve-container"><div class="barbecue-image"><img src="../images/Absolute Barbecue.jpg" class="abbq-jpg"></div>
    <form class="book-a-table-form" method="POST" action="connect1.php">
